...
app.get("/", (request, response) =>{
    const selectCommand = "SELECT name, email FROM alexandrecoutinho_02mb"
...
app.post("/login", (request, response ) => {
    ...
    const selectCommand = "SELECT * FROM alexandrecoutinho_02mb WHERE email = ?"
...
app.post("/cadastrar",  (request, response) => {
    ...
    const insertCommand = `
        INSERT INTO alexandrecoutinho_02mb(name, email, password)
        VALUES(?, ?, ?)
    `
